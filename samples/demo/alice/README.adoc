...
Ideas for further development of the demo:

* Applications can have locations, either physical on-prem data center, or virtual/zone for cloud apps (e.g. Amazon/Azure, US/EU, etc.)
* Link planned/pilot apps and projects that develop them
